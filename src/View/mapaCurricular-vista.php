        ...
        <div class="row g-0">
            ...
            <div class="col-lg-4 col-sm-6 text-center p-3">
                <div class="area shadow-sm p-4">
                    ...
                    <p class="areaText">Fomentar valores profesionales, humanísticos 
                        y éticos para la formación integral del estudiante y su 
                        desarrollo como individuo responsable..</p>
                </div>
            </div>
